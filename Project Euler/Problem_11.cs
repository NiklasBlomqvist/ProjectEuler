...
namespace ProjectEuler
{
    ...
    {
        // Problem input (using github copilot to clean data up so as to not do it manually).
        ...
        private const int adjacentNumberCount = 4;
        ...
        private static bool IndexOutOfRange(int row, int column)
        {
            var rows = input.GetLength(0);
            var columns = input.GetLength(1);
